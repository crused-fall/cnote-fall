...
于是经过一番机械式的复数运算，我们得到$$\begin{aligned}\int g(x)\,dx &=\frac{1}{100}e^x\left[(25x-1)\cos(x)+(-15x+3)\cos(3x)-25x\sin(x)+(5x+4)\sin(3x)\right]+C\end{aligned}$$
所以我们总结一下思路：

> [!tip] 思路1.7：通过欧拉公式计算不定积分的技巧
