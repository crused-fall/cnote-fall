...
上述结果实际上就是$|\text{Cov}(1_A,1_B)|$上界的控制我们参考，参考[[Kantorovich不等式#3.3 用上述思路证明一个类似的不等式]]当中的不等式$$|\text{Cov}(1_A,1_B)|\leq V(1_A)^{1/2}V(1_B)^{1/2}\leq \frac{1}{4}$$因为$1_A(\omega),1_B(\omega) \in [0,1],\forall \omega \in \Omega$。
