...
2.  如果$A_2$表示全体的square-free的自然数，那么实际上是数论当中的一个经典的练习题目 $\left|A_2\cap\{1,...,N\}\right|=\frac{6}{\pi^2}+O\left(\frac{1}{\sqrt{N}}\right)$因此$d(A_2)=\frac{6}{\pi^2}$。参考[[前$N$个自然数当中，square-free的自然数的占比是多少]]。
