...
更多的例子:
* [[Re0微积分1：用牛顿迭代法求算术平方根]]当中我们为了证明$x_n,n\geq 2$的时候满足迭代关系$$x_{n+1}:=\frac{1}{2}\left(x_n+\frac{a}{x_n}\right)\geq  \sqrt{a}$$的序列的下界，我们使用了AM-GM的不等式。因为其中结构$x_n+\frac{a}{x_n}$让我们意识到，用不等式可以把它转换为相乘的其结构，这个结构会更为简单。
