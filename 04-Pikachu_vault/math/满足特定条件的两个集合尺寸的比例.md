...
例如在[[Borel-Cantelli lemma及其应用#2.2.2 利用集合的特征函数]]当中，我们为了估计一系列集合交集的测度和的下界，于是考虑特征函数和$\sum_{T\leq n\leq Q} 1_{A_n}(x)$的积分，特征函数乘积的和$\sum_{T\leq n,m\leq Q} 1_{A_n}(x)1_{A_m}(x)$的积分。
