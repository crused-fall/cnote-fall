...
那么对$Y_n$关于测度$P$求积分，根据[[Weierstrass逼近定理的概率途径证明#1.6 $f(Y_n)$的期望]]给出的积分换元公式，我们知道$$\int_{\Omega} f_n\circ T \, dP = \int_{\mathbb{R}^n} f_n\,d(T_{*}P)=\int_{\mathbb{R}^n} f_n\,d(P_{X_1,...,X_n})$$
